...
func EncodeToString(origdata string) string { //必须配合原始的aes加密数据，才能使他们string(),加密的aes本质为16进制，字节数组是10进制
	return hex.EncodeToString([]byte(origdata))
}

// var DecodeString = hex.DecodeString([]byte)

func DecodeString(cipherdata string) string {
